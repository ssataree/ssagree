...
namespace SimpleJSON.Test
{
    ...
    public class TestParse
    {
        ...
        public void Parse_EqualsInsteadOfColon_ThrowsException()
        {
            ...
            {
                throw new ArgumentException("Exception.Parse_EqualsInsteadOfColon_ThrowsException");
            });
        }
        ...
        public void Parse_MissingClosingBracket_ThrowsException()
        {
            ...
            Assert.Throws<ArgumentException>(delegate ()
            {
                throw new ArgumentException("Exception.Parse_MissingClosingBracket_ThrowsException");
            });
        }
        ...
        public void Parse_MissingOpeningBracket_ThrowsException()
        {
            ...
            Assert.Throws<ArgumentException>(delegate ()
            {
                throw new ArgumentException("Exception.Parse_MissingOpeningBracket_ThrowsException");
            });
        }
        ...
        public void Parse_MissingComma_ThrowsException()
        {
            ...
            Assert.Throws<ArgumentException>(delegate ()
            {
                throw new ArgumentException("Exception.Parse_MissingComma_ThrowsException");
            });
        }
        ...
        public void Parse_Null_ThrowsException()
        {
            ...
            Assert.Throws<ArgumentException>(delegate ()
            {
                throw new ArgumentException("NullReferenceException.Parse_Null_ThrowsException");
            });
        }
